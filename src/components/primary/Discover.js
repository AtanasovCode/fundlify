...
const Discover = ({
    ...
    const newest = query(colRef, orderBy("createdAt", "desc"));
    const oldest = query(colRef, orderBy("createdAt", "asc"));
    const mostFunded = query(colRef, orderBy("moneyBacked", "desc"));
    const mostBackers = query(colRef, orderBy("backers", "desc"));

    useEffect(() => {
        onSnapshot(newest, (snapshot) => {
            let project = [];
    ...
    return (
        <div className="discover-container">
            ...
            <div className="discover-filter-container">
                ...
                <div className="discover-location-filter discover-filter">
                    <div className="discover-filter-text">
                        projects on
                    </div>
                    <div className="discover-input-filter-container">
                ...
                <div className="discover-projects-filter discover-filter">
                    ...
                    <div className="discover-input-filter-container">
                        <select className="discover-input-filter">
                            <option value="new">
                                Newest
                            </option>
                        </select>
